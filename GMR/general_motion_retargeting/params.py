...
ROBOT_XML_DICT = {
    ...
    "unitree_g1_auto": ASSET_ROOT / "unitree_g1" / "g1_mocap_29dof.xml",
    ...
    "roboot16": REPO_ROOT / "Roboot1.6" / "xml" / "roboot16_1.xml",
}

VIEWER_XML_DICT = {
    # Use a scene file for visualization when the robot model XML itself has no floor.
    "roboot16": REPO_ROOT / "Roboot1.6" / "xml" / "scene_1.xml",
}
...
IK_CONFIG_DICT = {
    ...
    "bvh_lafan1":{
        ...
        "unitree_g1_auto": IK_CONFIG_ROOT / "bvh_lafan1_to_g1_auto.json",
        ...
        "roboot16": IK_CONFIG_ROOT / "bvh_lafan1_to_roboot16.json",
    },
    "bvh_nokov":{
